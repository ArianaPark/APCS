...
public class Picture extends SimplePicture 
{
    ...
    public void mirrorTemple()
    {
        ...
        int count = 0;
        for(int i=27; i<97; i++){
            for(int j=13; j<mirrorPoint; j++){
                left = pixels[i][j];
                right = pixels[i][mirrorPoint -j +mirrorPoint];
                right.setColor(left.getColor());
                count++;
            }
        }
    ...
    public void mirrorArms(){
        ...
        Pixel up = null;
        Pixel down = null;
        for(int i=160; i<mirrorPoint; i++){
            for(int j=0; j<pixels[0].length; j++){
                up = pixels[i][j];
                down = pixels[mirrorPoint -i +mirrorPoint][j];
    ...
    public void mirrorGull(){
        //copy seagull next to one already there
    }
